...
<div class="form-group" id="author_form_group">
    <label class="xe-form__label--requried">대상필드 ID</label>
    <input class="form-control" type="text" id="" name="target_field_id" value="{{$config->get('target_field_id')}}">
</div>
