...
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFields\Questionnaire;
...
class Questionnaire extends AbstractType
{
    ...
    protected static $path = 'dynamic_field_extend/src/DynamicFields/Questionnaire';
    ...
    {
        dd($config);
        return view('dynamic_field_extend::src/DynamicFields/Questionnaire/views/setting',[
            'config' => $config
        ]);
    }
