<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\TableCheckBox;

use Xpressengine\DynamicField\AbstractSkin;
use Config;

class TableCheckBox extends AbstractSkin
{
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.TableCheckBox.views';
    }
