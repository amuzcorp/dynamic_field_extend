<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\MediaNotEditor;

use Xpressengine\DynamicField\AbstractSkin;
use Config;

class MediaNotEditorSkin extends AbstractSkin
{
    ...
    {
        //return '미디어 라이브러리 에디터 안 쓰는 버전';
        return 'Media library Not Editor Version';
    }
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.MediaNotEditor.views';
    }
