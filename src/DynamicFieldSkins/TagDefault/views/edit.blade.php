...
--}}
@if(!isset($args['instance_id']) || $args['instance_id']!="xe_blog")
    <div class="xe-form-group xe-dynamicField">
        @if($config_dynamic->get('hash_tag') == 1)
            ...
            @endif
            <input type="hidden" name="tag_column" value="{{time()}}">
            ...
            <div id="xeBoardTagWrap" class="xe-select-label __xe-board-tag" data-tags="{{ $args['strTags'] }}"
                ...
                <vue-tags-input v-model="tag" :tags="tags" @tags-changed="update"
