<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\TagDefault;
...
class TagDefault extends AbstractSkin
{
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.TagDefault.views';
    }
