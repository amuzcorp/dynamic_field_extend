<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\ColorPickerDefault;

use Xpressengine\DynamicField\AbstractSkin;

class ColorPickerDefault extends AbstractSkin
{
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.ColorPickerDefault.views';
    }
