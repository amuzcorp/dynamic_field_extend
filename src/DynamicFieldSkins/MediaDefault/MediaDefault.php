<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\MediaDefault;

use Xpressengine\DynamicField\AbstractSkin;
use Config;

class MediaDefault extends AbstractSkin
{
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.MediaDefault.views';
    }
