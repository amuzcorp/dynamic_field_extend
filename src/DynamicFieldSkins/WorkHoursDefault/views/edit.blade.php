<div class="xe-form-group xe-dynamicField">
    ...
    <div class="xu-form-group__box">
        <input type="text" name="{{ $key['column']}}" class="xe-form-control xu-form-group__control __xe_df __xe_df_text __xe_df_text_{{$config->get('id')}}"
               value="{{ $data['column'] }}" data-valid-name="{{ xe_trans($config->get('label')) }}"
