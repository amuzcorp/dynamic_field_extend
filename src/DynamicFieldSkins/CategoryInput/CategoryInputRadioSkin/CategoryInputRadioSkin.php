<?php
namespace Amuz\XePlugin\DynamicField\DynamicFieldSkins\CategoryInput\CategoryInputRadioSkin;

use Xpressengine\DynamicField\AbstractSkin;

class CategoryInputRadioSkin extends AbstractSkin
{
    ...
    {
        return 'dynamic_field::src.DynamicFieldSkins.CategoryInput.CategoryInputRadioSkin.views';
    }
