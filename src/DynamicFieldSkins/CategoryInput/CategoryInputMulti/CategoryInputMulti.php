<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\CategoryInput\CategoryInputMulti;

use Xpressengine\DynamicField\AbstractSkin;

class CategoryInputMulti extends AbstractSkin
{
    ...
    {
        //return 'CategoryInputMulti fieldSkin';
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.CategoryInput.CategoryInputMulti.views';
    }
