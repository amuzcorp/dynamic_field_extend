<?php
namespace Amuz\XePlugin\DynamicField\DynamicFieldSkins\CategoryInput\CategoryInputCheckSkin;

use Xpressengine\DynamicField\AbstractSkin;

class CategoryInputCheckSkin extends AbstractSkin
{
    ...
    {
        //return 'CategoryInputCheckSkin fieldSkin';
    ...
    {
        return 'dynamic_field::src.DynamicFieldSkins.CategoryInput.CategoryInputCheckSkin.views';
    }
