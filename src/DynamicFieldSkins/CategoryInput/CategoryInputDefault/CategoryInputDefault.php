<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\CategoryInput\CategoryInputDefault;

use Xpressengine\DynamicField\AbstractSkin;

class CategoryInputDefault extends AbstractSkin
{
    ...
    {
        //return 'CategoryInputDefault fieldSkin';
        return 'Category input default';
    }
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.CategoryInput.CategoryInputDefault.views';
    }
