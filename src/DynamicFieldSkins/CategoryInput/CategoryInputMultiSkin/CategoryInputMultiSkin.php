<?php
namespace Amuz\XePlugin\DynamicField\DynamicFieldSkins\CategoryInput\CategoryInputMultiSkin;

use Xpressengine\DynamicField\AbstractSkin;

class CategoryInputMultiSkin extends AbstractSkin
{
    ...
    {
        //return 'CategoryInputMultiSkin fieldSkin';
        return 'Category input multiselect';
    }
    ...
    {
        return 'dynamic_field::src.DynamicFieldSkins.CategoryInput.CategoryInputMultiSkin.views';
    }
