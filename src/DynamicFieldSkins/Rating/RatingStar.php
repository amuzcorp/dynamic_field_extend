...
{
    protected static $id = 'fieldType/dynamic_field_extend@Rating/fieldSkin/dynamic_field_extend@RatingStar';
    ...
    {
        return 'Rating for Number With Star';
    }
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.Rating.views';
    }
