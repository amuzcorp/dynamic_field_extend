<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\SurveyDefault;

use Xpressengine\DynamicField\AbstractSkin;
use Config;

class SurveyDefaultSkin extends AbstractSkin
{
    ...
    public function name()
    {
        ...
        return 'Survey Field DefaultSkin';
    }
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.SurveyDefault.views';
    }
    ...
    public function show(array $args)
    {
        ...
        $configManager = app('xe.config');
        $config_dynamic = $configManager->get('dynamic_field_extend');
        $content = json_decode($args[$this->config->get('id').'_column']);
        if($config_dynamic->get('edittable') == 1) {
