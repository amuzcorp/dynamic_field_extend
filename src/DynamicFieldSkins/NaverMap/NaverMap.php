<?php
namespace Amuz\XePlugin\DynamicFieldExtend\DynamicFieldSkins\NaverMap;

use Xpressengine\DynamicField\AbstractSkin;

class NaverMap extends AbstractSkin
{
    ...
    {
        return 'dynamic_field_extend::src.DynamicFieldSkins.NaverMap.views';
    }
