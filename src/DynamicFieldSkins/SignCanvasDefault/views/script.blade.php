 ...
 */
    ...
    var saveButton = document.getElementById("{{$config->get('id')}}_save"),
        clearButton = document.getElementById("{{$config->get('id')}}_clear");
    ...
    saveButton.addEventListener('click', function(event) {
        ...
        window.XE.toast('success', '서명이 확인되었습니다');
        document.getElementById("{{$config->get('id')}}_closeModal").click();

        var sign_image_field = document.getElementById("{{$config->get('id')}}_sign_field");
        sign_image_field.innerHTML = '';
        sign_image_field.innerHTML = '<img src="'+data+'" style="width:400px; height:200px;">';
        // window.open(data);
    });
